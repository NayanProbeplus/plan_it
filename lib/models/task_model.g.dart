...
void _taskSerialize(
  ...
  writer.writeBool(offsets[4], object.remind);
}
...
Task _taskDeserialize(
  ...
  final object = Task(
    ...
    remind: reader.readBool(offsets[4]),
  );
  return object;
}
...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> remindEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'remind',
        value: value,
...
extension TaskQueryProperty on QueryBuilder<Task, Task, QQueryProperty> {
  ...
  QueryBuilder<Task, bool, QQueryOperations> remindProperty() {
    return QueryBuilder.apply(this, (query) {
